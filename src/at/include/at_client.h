...
#define RING_BUFF_LEN         		   AT_CMD_MAX_LEN	 

#define CLINET_BUFF_LEN				   1024
#define GET_CHAR_TIMEOUT_MS			   5000
#define CMD_TIMEOUT_MS			   	   50000
...
#define at_exec_cmd(resp, custom_flag, data_type, data_size, ...)                   at_obj_exec_cmd(resp, custom_flag, data_type, data_size, __VA_ARGS__)
