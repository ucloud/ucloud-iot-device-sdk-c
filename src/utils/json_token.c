...
int LITE_get_int32(int32_t *value, char *src) {
	return (sscanf(src, "%" SCNi32, value) == 1) ? SUCCESS : FAILURE;
}

int LITE_get_int16(int16_t *value, char *src) {
	return (sscanf(src, "%" SCNi16, value) == 1) ? SUCCESS : FAILURE;
}

int LITE_get_int8(int8_t *value, char *src) {
	return (sscanf(src, "%" SCNi8, value) == 1) ? SUCCESS : FAILURE;
}

int LITE_get_uint32(uint32_t *value, char *src) {
	return (sscanf(src, "%" SCNu32, value) == 1) ? SUCCESS : FAILURE;
}

int LITE_get_uint16(uint16_t *value, char *src) {
	return (sscanf(src, "%" SCNu16, value) == 1) ? SUCCESS : FAILURE;
}

int LITE_get_uint8(uint8_t *value, char *src) {
	return (sscanf(src, "%" SCNu8, value) == 1) ? SUCCESS : FAILURE;
}

int LITE_get_float(float *value, char *src) {
	return (sscanf(src, "%f", value) == 1) ? SUCCESS : FAILURE;
}

int LITE_get_double(double *value, char *src) {
	return (sscanf(src, "%lf", value) == 1) ? SUCCESS : FAILURE;
}
